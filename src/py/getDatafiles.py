...
def getfile(name: str = "Melanoma", what: str = "normed_counts") -> dict[str, str]:
    ...
    """
    js = json.load(
        open(pathlib.Path(__file__).parent.parent / "data" / "folder_structure.json")
    )
    if name == "Melanoma":
        print(js["Melanoma"]["normed_counts"])
        return {
            "normed_counts": pathlib.Path(__file__).parent.parent
            / "data"
            / "Melanoma"
            / js["Melanoma"]["normed_counts"]
        }
    if name == "Exp1":
        if what == "all":
            out = {}
            ...
            return {
                ...
                / "AllonKleinLab"
                / "Experiment1"
                / js["AllonKleinLab"]["Experiment1"]["normed_counts"]
            }
    if name == "Exp2":
        if what == "all":
            out = {}
            ...
            return {
                ...
                / "AllonKleinLab"
                / "Experiment2"
                / js["AllonKleinLab"]["Experiment2"]["normed_counts"]
            }
    if name == "Exp3":
        if what == "all":
            out = {}
            ...
            return {
                ...
                / "AllonKleinLab"
                / "Experiment3"
                / js["AllonKleinLab"]["Experiment3"]["normed_counts"]
            }
