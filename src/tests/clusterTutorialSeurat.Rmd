...
pbmc.data <- Read10X(data.dir = "/app/data/pbmc/hg19")
...
ggsave(filename = "../out/pbmc/hg19/pbmc3k_umap.jpg", height = 7, width = 12, plot = plot, quality = 50)
```

```{r save.rds, eval=FALSE}
saveRDS(pbmc, file = "../out/pbmc/hg19/pbmc3k_final.rds")
```

```{r save.times, include = FALSE}
write.csv(x = t(as.data.frame(all_times)), file = "/app/out/pbmc/hg19/pbmc3k_tutorial_times.csv")
```
