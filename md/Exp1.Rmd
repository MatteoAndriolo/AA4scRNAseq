...
se <- Matrix::readMM("../data/AllonKleinLab/Experiment1/stateFate_inVitro_normed_counts.mtx" )
...
if (any(is.na(m)) || any(is.infinite(m))) {
  stop("The data matrix still contains NA or infinite values after cleaning.")
}
