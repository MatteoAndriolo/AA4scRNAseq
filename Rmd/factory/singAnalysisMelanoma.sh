...
#SBATCH --output=./out/Melanoma/RMDAnslurm_output.txt
#SBATCH --error=./out/Melanoma/RMDAnslurm_error.txt
...
command="Rmd/_main_analysis.sh $FOLDER_PATH $INPUT_FILE $OUTPUT_FILE"
