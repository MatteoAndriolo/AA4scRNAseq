...
#_ clone_matrix <- Matrix::readMM("data/AllonKleinLab/Experiment3/stateFate_inVivo_clone_matrix.mtx")
#_ gene_names <- read.table("data/AllonKleinLab/Experiment3/stateFate_inVivo_gene_names.txt",sep="\t")
#_ metadata <- read.table("data/AllonKleinLab/Experiment3/stateFate_inVivo_metadata.txt",sep="\t")

data_path="../data/AllonKleinLab/Experiment3/stateFate_inVivo_normed_counts.mtx"
